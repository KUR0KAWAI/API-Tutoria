...
switch (true) {
    ...
    // GET /api/reportes-tutoria/estadisticas-jornada
    case $uri === '/api/reportes-tutoria/estadisticas-jornada' && $method === 'GET':
        $reportesTutoriaController->getEstadisticasJornada($currentUser);
        break;

    // GET /api/reportes-tutoria/kpi-gestion-docente
    case $uri === '/api/reportes-tutoria/kpi-gestion-docente' && $method === 'GET':
        $reportesTutoriaController->getKpiGestionDocente($currentUser);
        break;

    // GET /api/reportes-tutoria/kpi-asistencia-efectiva
    case $uri === '/api/reportes-tutoria/kpi-asistencia-efectiva' && $method === 'GET':
        $reportesTutoriaController->getKpiAsistenciaEfectiva($currentUser);
        break;

    // GET /api/reportes-tutoria/kpi-impacto-academico
    case $uri === '/api/reportes-tutoria/kpi-impacto-academico' && $method === 'GET':
        $reportesTutoriaController->getKpiImpactoAcademico($currentUser);
        break;
    ...
    // GET /api/documentos/reporte (IMPORTANTE: Antes de /api/documentos para evitar conflicto si fuera regex, aunque aquí es exacto)
    case $uri === '/api/documentos/reporte' && $method === 'GET':
        $documentoController->getReporteDocumentos($currentUser);
        break;
